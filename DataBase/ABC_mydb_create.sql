...
CREATE TABLE IF NOT EXISTS `mydb`.`Lease` (
  `lease_id` SMALLINT(5) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Reservable_equipment` (
  ...
  CONSTRAINT `fk_reservableEquipment_inventory`
...
CREATE TABLE IF NOT EXISTS `mydb`.`Reservation_equipment` (
  ...
  INDEX `fk_reservation_id_idx` (`fk_reservation_id` ASC, `fk_reservable_equipment_id` ASC) VISIBLE,
  CONSTRAINT `fk_reservationEquipment_reservableEquipment`
